...
list1 = Listbox(window, height=20, width=55)
...
b4 = Button(window, text="Update Selected ", width=12, command=update_comand)
b4.grid(row=5, column=3)

b5 = Button(window, text="Delete Selected ", width=12, command=delete_comand)
